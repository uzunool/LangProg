...
//Примеры использоания статических переменных и методов
class StaticDemo {
	int x;
	static int y;
...
//Создание объектов для демонстрации статических перемннных
		...
		System.out.println("Переменный ob1.x и ob2.x независимиы");
